...
from web.hr.assignPayScale import AssignPayScaleHandler
from web.hr.rule import RuleHandler
from web.hr.userRuleMap import UserRuleMapHandler
from web.hr.updateSalary import UpdateSalaryHandler
from web.hr.joinNewEmp import JoinNewEmpHandler
from web.hr.resignation import ResignationHandler
from web.hr.userDetails import ResignationUserHandler
    ...
    def __init__(self):
        ...
        super(App, self).__init__(
            handlers=[
                ...
                (r'/v1/api/assign/payscale', AssignPayScaleHandler),
                (r'/v1/api/rule', RuleHandler),
                (r'/v1/api/user/rule/map', UserRuleMapHandler),
                (r'/v1/api/update/salary', UpdateSalaryHandler),
                (r'/v1/api/join/new/employee', JoinNewEmpHandler),
                (r'/v1/api/resignation', ResignationHandler),
                (r'/v1/api/resignation/user', ResignationUserHandler),
            ],
            **settings,
